...
<section class="w3l-faq-6">
	<div class="faq-page">
		<div class="wrapper">
			...
			<details open>
				<summary>
					What is the meaning of a Agriportal?
					<span class="fa control-icon-expand fa-chevron-down"></span>
					<span class="fa control-icon-close fa-times"></span>
				</summary>
				<p>An Agriportal is a digital platform or website that serves as a comprehensive resource for agricultural information, services, and transactions, facilitating communication and interaction among stakeholders in the agriculture sector. </p>
			</details>
			<details>
				<summary>
				...
				<p>Sustainable farming practices aim to minimize environmental impact while maintaining productivity, using techniques like crop rotation, organic fertilizers, and integrated pest management.
			...
			<details>
				...
				<p>Organic farming avoids synthetic chemicals and promotes soil health through natural fertilizers and pest control, while conventional farming uses synthetic inputs to maximize yields.

				</p>
			</details>
			<details>
				<summary>
					What types of services do agriculture service providers offer?
					<span class="fa control-icon-expand fa-chevron-down"></span>
					<span class="fa control-icon-close fa-times"></span>
				</summary>
				<p>Agriculture service providers offer a range of services including soil testing, crop advisory, pest management, irrigation solutions, farm machinery rental, and market information. </p>
			</details>
			<details>
				<summary>
					What are the key principles of animal welfare in husbandry?
					<span class="fa control-icon-expand fa-chevron-down"></span>
					<span class="fa control-icon-close fa-times"></span>
				</summary>
				<p>Key principles include providing adequate nutrition, shelter, healthcare, and handling practices that minimize stress and ensure the animals' physical and behavioral needs are met. </p>
			</details>
			<details>
				<summary>
				...
				<p>Organic farming reduces exposure to pesticides and synthetic fertilizers in food, potentially lowering the risk of health issues associated with chemical residues, promoting safer and more nutritious food options. </p>
			</details>
		</div>
	</div>
</section>
