...
<head>
  ...
  <title>AGRIPORTAL | Services</title>
				...
				<div class="column">
					<a href="single.html">
						<div>
							...
							<h6 class="feature-heading">Irrigation Service</h6>
							<p class="feature-para">Irrigation is the controlled application of water to crops, ensuring optimal growth by delivering water directly to roots, crucial for agriculture in regions with insufficient rainfall or dry seasons.
							</p>
						</div>
					</a>
				</div>
				<div class="column">
					<a href="single.html">
						<div>
							...
							<h6 class="feature-heading">Plantation Service</h6>
							<p class="feature-para">Plantation agriculture involves large-scale cultivation of cash crops such as coffee, tea, and rubber, typically in tropical regions, for commercial purposes and economic sustainability.</p>
						</div>
					</a>
				</div>
				<div class="column">
					<a href="single.html">
						<div>
							...
							<h6 class="feature-heading">Harvesting</h6>
							<p class="feature-para">Harvesting is the process of gathering mature crops from fields, orchards, or vineyards, ensuring optimal timing for peak yield and quality before processing or consumption.</p>
						</div>
					</a>
				</div>
				...
				<div class="column">
					<a href="single.html">
						<div>
							...
							<h6 class="feature-heading">Crop Spray</h6>
							<p class="feature-para">Crop spraying involves applying pesticides, herbicides, or fertilizers to crops using sprayers, ensuring effective pest and weed control, nutrient supplementation, and overall crop health management.</p>
						</div>
					</a>
				</div>
				<div class="column">
					<a href="single.html">
						<div>
							...
							<h6 class="feature-heading">AgriGrow Consulting</h6>
							<p class="feature-para">AgriGrow Consulting provides comprehensive agricultural advisory services, specializing in crop management, soil health, irrigation strategies, and sustainable farming practices to optimize yield, profitability, and environmental stewardship.</p>
						</div>
					</a>
				</div>
				...
				<div class="column">
					<a href="single.html">
						<div>
							...
							<h6 class="feature-heading">FarmTech Solutions</h6>
							<p class="feature-para">FarmTech Solutions offers innovative agricultural technologies and services, enhancing farm efficiency through precision farming, data analytics, and sustainable practices for optimized production and profitability.</p>
						</div>
					</a>
				</div>
			</div>
		...
		<div class="w3l-form-12-content">
			<div class="wrapper">
				<div class="grid grid-column-2 ">
						<div class="column2">
								 <img src="assets/images/ser-1 (1).png" style="margin-top: 50px;margin-left: -80px;" /> 
						</div>
					<div class="column1">
			...
			<div class="grids-content">
				<div class="column">
					<a href="#">
						<div class="content">
							...
							<img src="assets/images/grassservice1.jpg" class="image-two img-responsive">
							<div class="content-details fadeIn-bottom">
								<h4 class="content-title">Cutting service</h4>

							</div>
						</div>
					</a>
					<h4><a href="#">Cutting Service</a></h4>
					<p>Agricultural cutting services involve the efficient harvesting and pruning of crops or vegetation, ensuring optimal timing and techniques for maximizing yield and quality. </p>
				...
				<div class="column">
					<a href="#">
						<div class="content">
							<div class="content-overlay"></div>
							<img src="assets/images/plantCare.jpg" class="image-two img-responsive">
							<div class="content-details fadeIn-bottom">
					...
					<p>Plant caring involves nurturing plants through watering, fertilizing, pruning, and pest control to ensure healthy growth, optimal yield, and aesthetic appeal in gardens or farms.
				...
				<div class="column">
					<a href="#">
						<div class="content">
							<div class="content-overlay"></div>
							<img src="assets/images/Animal-h.jpg" class="image-two img-responsive">
							<div class="content-details fadeIn-bottom">
								<h4 class="content-title">Animal husbandry</h4>

							</div>
						</div>
					</a>
					<h4><a href="#">Animal husbandry</a></h4>
					<p>Animal husbandry entails the breeding, feeding, housing, and healthcare management of livestock to ensure their welfare, productivity, and sustainability in agricultural operations </p>
				</div>
