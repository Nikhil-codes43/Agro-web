		...
		<div class="ab-grids-6">
			<div class="wrapper">
				<div class="content23-head text-center">
					<h3 class="hny-title"><span class="sub-title">About Us</span>Welcome to AgriPortal </h3>
					<p>An agriportal serves as a centralized platform facilitating agricultural information dissemination, market trends, farmer support, and policy updates. It integrates resources like crop advisories, weather forecasts, agricultural news, and e-commerce, enhancing accessibility, productivity, and decision-making for farmers and stakeholders in the agricultural sector.</p>
				</div>
				<div class="d-grid content23-col-2 text-center">
					<div class="content23-grid">
						<h4><a href="#">Preparing Seeds</a></h4>
						<p>Preparing seeds involves selecting, cleaning, treating, and storing them to ensure viability and optimal germination success in planting.</p>
					</div>
					<div class="content23-grid1">
						<h4><a href="#">Crop Cutting</a></h4>
						<p>Crop cutting involves harvesting mature crops, ensuring proper timing and techniques to maximize yield and quality. </p>
					</div>
				</div>
			</div>
		</div>
	...
	<div class="w3l-counter-top-6">
		...
		<section id="counter-6-inf-block" class="counter-main">
			<div class="wrapper-full-gd">
				<div class="d-grid align-counter-6-inf-cols">
					<div class="counter-6-inf-left second" style="height: 631px;">
						<h5 class="heading">Our capabilities</h5>
						<h3 class="hny-title two">Integrate nature into your home.</h3>
					...
					<div class="counter-6-inf-right">
						<div class="d-grid grid-col-2">
							<div class="specification">
								...
								<h6>Irrigation System</h6>
								<p>Irrigation ensures crops receive sufficient water for healthy growth..</p>
							</div>
							<div class="specification">
								<span class="fa fa-tractor"></span>
								<h6>Crop Harvesting</h6>
								<p>gathering mature crops for processing or consumption with efficiency</p>
							</div>
							<div class="specification spec-gap">
								<span class="fa fa-cow"></span>
								<h6>Animal husbandry</h6>
								<p>Animal husbandry involves breeding, raising, and caring for livestock for various purposes.</p>
							...
							<div class="specification spec-gap">
								...
								<h6>Nursery System</h6>
								<p>Nursery systems cultivate young plants in controlled environments for later transplantation.</p>
							</div>
						</div>
					</div>
				</div>
		...
		<section class="w3l-teams-main-6">
			...
			<div class="team-sec-info">
				<div class="wrapper">
					<h3 class="hny-title text-center"><span class="sub-title">Our Farming Expert Team</span>Agricultural specialists
					</h3>
					<div class="d-grid grid-col-2 main-contteam-28">
						<div class="team-main-19">
							...
							<div class="right-team-9">
								<h6><a href="team-single.html" class="title-team-28">Dr. Rajesh Singh
								</a></h6>
								...
								<ul class="team-details">
									...
									<li><a href="mailto:Designer1@mail.com" class="mail"><span
												class="fa fa-envelope"></span> Rajesh@mail.com</a></li>
				...
				<div class="wrapper">
					<div class="grid">
						...
						<div class="float-rt text-right">
							<ul class="buttons">
								<li class="phone"><span class="fa fa-mobile" aria-hidden="true"></span> +919432534217</li>
